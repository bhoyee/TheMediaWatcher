    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-lg-12">
          ...
          <div class="bg-light shadow-sm rounded p-4 mb-4">
            <h3 class="text-5 font-weight-400">Upload Specific Company Data</h3>
      ...
      <div class="container">
		...
		<?php
                ...
                $query = "SELECT id,date,time,brand,campaign,station,medium,duration,company,industry,language,program,region FROM data_bank WHERE company = '$comp' AND post_date = '$cDate'";
