      ...
      <div class="row"> 
        ...
        <div class="col-lg-12">
          ...
          <div class="bg-light shadow-sm rounded p-4 mb-4">
            ...
            <p class="text-muted">Use below to add user / client to company </p>
            ...
            <?php
               ...
               if (isset($_POST['add_user'])) {
                  ...
                  $cname = trim($_POST['comname']);
                  $user= trim($_POST['user']);
            

                  $sqlli = "INSERT INTO ucompany (userID, c_id) VALUES ('$user', '$cname')";
              ...
              {   
                  ...
                  $query = "UPDATE ucompany SET userID='$userID', c_id ='$c_id' WHERE id='$id'  ";
              ...
              if(isset($_POST['deletedata']))
                {
                    ...
                    $querydel ="DELETE FROM ucompany
                    WHERE ucompany.id='$id'";
            ...
            <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#create-company">
              <i class="fa fa-plus"></i> Add User to company
              </button>
            </div>
            <!-- <div class="col-6">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title font-weight-400">Edit / Update User Company Detail</h5>
                      ...
                      <input type="hidden" name="client_id" id="client_id">
                        ...
                        <div class="form-group">
                          ...
                          <select class="custom-select" id="cname" name="cname" >
                                ...
                                <?php
                                $sqli = "SELECT id, name FROM company";
                        ...
                        <div class="form-group">
                          ...
                          <select class="custom-select" id="user" name="user" >
                                ...
                                $sqlii = "SELECT userID, username FROM users WHERE status = 'Advertiser' OR status = ''";
          ...
          <div id="create-company" class="modal fade " role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title font-weight-400">Add Client/ User to Compay</h5>
                  <button type="button" class="close font-weight-400" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                </div>
                <div class="modal-body p-4">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          <label for="cname">Company Name</label>
                                ...
                                <select class="custom-select" id="comname" name="comname" require>
