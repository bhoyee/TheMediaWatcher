...
<body>
    ...
    ?>
        ...
        <tr> <td style="border:1px solid #cccccc;font-size:9.2px;"><?php echo $productResult[0]["brand"]; ?> : For 15 SEC Duration, <?php echo($belt); ?> belt</td>
        ...
        <tr> <td style="border:1px solid #cccccc; font-size: 9.2px;"><?php echo $productResult[0]["brand"]; ?> : For 30 SEC Duration, <?php echo($belt); ?> belt</td>
        ...
        <tr> <td style="border:1px solid #cccccc; font-size: 9.2px;"><?php echo $productResult[0]["brand"]; ?> : For 45 SEC Duration, <?php echo($belt); ?> belt</td>
        ...
        <tr> <td style="border:1px solid #cccccc; font-size: 9.2px;"><?php echo $productResult[0]["brand"]; ?> : For 60 SEC Duration, <?php echo($belt); ?> belt</td>
