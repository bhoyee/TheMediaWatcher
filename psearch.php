                     ...
                     <div class="col-sm ">
                        <div class="form-group">
                          ...
                          <option value="">Select Station</option>
                                ...
                                $sqli = "SELECT ustation.id AS id, ustation.userID AS userID, station.name AS sname FROM ustation INNER JOIN station ON station.id = ustation.s_id WHERE ustation.userID = '$userID'";
					...
					<tbody>
                        <?php 
                       	...
                       	if (isset($_POST['submit'])){
                            ...
                            $oquery = $conn->query("select date, time, brand,adtype, campaign, station, medium, duration, company, industry, language,program, region from data_bank where date between '$from' and '$to' and station='$station' and adtype='$adtype'");

                            while($orow = $oquery->fetch_array()){
                                $_SESSION['station'] =  $orow['station'];
                                ?>  
                        <tr>
                            <!-- <td>-->
                            <!--    <?php echo $i; $i++; ?> -->
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="footer-copyright pt-3 pt-lg-2 mt-2">
        <div class="row">
          <div class="col-lg">
          <p class="text-center text-lg-left mb-2 mb-lg-0">Copyright &copy; 2022 <a href="#">TheMeadiaWatcher</a>. All Rights Reserved.</p>
          </div>
