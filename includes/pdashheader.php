          ...
          <nav class="primary-menu navbar navbar-expand-lg">
            <div id="header-nav" class="collapse navbar-collapse">
              <ul class="navbar-nav mr-auto">
                <li class="active"><a href="pdashboard">Dashboard</a></li>
                <li><a href="psearch">Download Data</a></li>
                <li><a href="psindex">Document</a></li>

                <!--<li><a href="pinvoice">Invoice</a></li>-->
                <li class="dropdown"> <a class="dropdown-toggle" href="#">Invoice</a>
                  <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="pinvoice">Generate Invoice</a></li>
                        <li><a class="dropdown-item" href="cpinvoice">Customise Invoice</a></li>  
                  </ul>
                </li>
